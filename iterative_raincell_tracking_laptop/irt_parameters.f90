...
INTEGER, PARAMETER    :: domainsize_x = 117
INTEGER, PARAMETER    :: domainsize_y = 117
...
INTEGER, PARAMETER    :: time_steps = 144    ! total number of timesteps
INTEGER, PARAMETER    :: nt_bins = 6         ! 2 hourly
